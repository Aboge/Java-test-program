...
* 维吉尼亚解密算法：
* */
public class Vigeneredemo1 {

    public static void main(String[] args) {
        String ciphertext = "KCCPKBGUFDPHQTYAVINRRTMVGRKDNBVFDETDGILTXRGUD" +
        ...
        System.out.println("秘文是"+ ciphertext);

        int keyLength = Friedman(ciphertext);

        decryptCipher(keyLength,ciphertext);
